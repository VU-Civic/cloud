...
pub fn orientation_to_quaternions(sensor_orientation: [i32; 3]) -> (f64, f64, f64, f64) {
  let qx = f64::from(sensor_orientation[1]) / 1_073_741_824.0;
  let qy = f64::from(sensor_orientation[2]) / 1_073_741_824.0;
  let qz = -f64::from(sensor_orientation[0]) / 1_073_741_824.0;
