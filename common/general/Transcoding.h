...
public:
  ...
  static uint32_t base85Encode(uint8_t* __restrict output, const uint8_t* __restrict input, uint32_t inputNumBytes);
  ...
  static std::vector<uint8_t> base85Decode(std::vector<uint8_t>&& encodedData);
